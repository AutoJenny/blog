-- Migration: Update Recipe Image Style Prompt to remove method image (third image)
-- Purpose: Deprecate the method image - only generate hero and ingredients images
-- Date: 2025-11-XX
