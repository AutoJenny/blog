...
CREATE TABLE public.workflow_field_mapping (
    ...
    accordion_type character varying(32) DEFAULT 'inputs'::character varying NOT NULL,
    target_id character varying(50) NOT NULL,
    CONSTRAINT workflow_field_mapping_accordion_type_check CHECK (((accordion_type)::text = ANY ((ARRAY['inputs'::character varying, 'outputs'::character varying])::text[])))
);
...
--
-- Name: COLUMN workflow_field_mapping.accordion_type; Type: COMMENT; Schema: public; Owner: nickfiddes
--

COMMENT ON COLUMN public.workflow_field_mapping.accordion_type IS 'Records whether this field is in the inputs or outputs accordion (inputs/outputs)';
...
COPY public.workflow_field_mapping (id, field_name, stage_id, substage_id, order_index, accordion_type, target_id) FROM stdin;
1	idea_seed	10	1	1	inputs	input1
2	basic_idea	10	1	2	outputs	input2
3	idea_scope	10	1	3	outputs	input3
4	provisional_title	10	1	4	outputs	input4
5	research_notes	10	2	1	outputs	input1
6	interesting_facts	10	2	2	outputs	input2
7	topics_to_cover	10	2	3	outputs	input3
8	section_planning	10	3	1	outputs	input1
9	section_headings	10	3	2	outputs	input2
10	section_order	10	3	3	outputs	input3
11	structure	10	3	4	outputs	input4
\.
...
31	1	Idea Seed	Initial seed for the post idea	2	{"inputs": {"input1": {"db_field": "idea_seed", "db_table": "post_development"}}, "field_mapping": [{"field_name": "idea_seed", "order_index": 0}, {"field_name": "basic_idea", "order_index": 1}, {"field_name": "provisional_title", "order_index": 2}, {"field_name": "idea_scope", "order_index": 3}]}	idea_seed	1
...
1	1	Initial	Main step for this substage	3	{"title": "Initial Concept", "inputs": {"input1": {"label": "Input Field", "db_field": "idea_seed"}}, "prompt": "[system] You are an expert in Scottish history and culture, dedicated to accuracy and authenticity in everything you do. You adhere to academic values, but love to popularise ideas to make them easily understandable to those with no knowledge of your specialism.\\n\\n[system] Expand the following short idea into a paragraph-length brief for a long-form blog article. The brief should outline the scope, angle, tone, and core ideas that could be developed into a full article. Use clear, engaging language.\\n\\nShort Idea:\\n[data:idea_seed]\\n\\nYour response should:\\n1. Focus specifically on Scottish cultural and historical aspects\\n2. Maintain academic accuracy while being accessible\\n3. Suggest clear angles and themes for development\\n4. Use UK-British spellings and idioms\\n5. Return only the expanded brief, with no additional commentary or formatting", "outputs": {"expanded_idea": {"type": "textarea", "label": "Expanded Idea", "db_field": "basic_idea", "db_table": "post_development"}}, "settings": {"llm": {"model": "llama3.1:70b", "provider": "ollama", "parameters": {"top_p": 0.9, "max_tokens": 1000, "temperature": 0.7, "presence_penalty": 0.0, "frequency_penalty": 0.0}}}, "description": "Enter your initial concept for the post here.", "field_mapping": [{"field_name": "idea_seed", "order_index": 0}, {"field_name": "basic_idea", "order_index": 1}, {"field_name": "provisional_title", "order_index": 2}, {"field_name": "idea_scope", "order_index": 3}]}	initial_idea	2
\.
...
SELECT pg_catalog.setval('public.workflow_field_mapping_id_seq', 11, true);
...
--
-- Name: workflow_field_mapping unique_mapping; Type: CONSTRAINT; Schema: public; Owner: nickfiddes
--

ALTER TABLE ONLY public.workflow_field_mapping
    ADD CONSTRAINT unique_mapping UNIQUE (substage_id, accordion_type, target_id);
...
--
-- Name: workflow_field_mapping workflow_field_mapping_unique_field_mapping; Type: CONSTRAINT; Schema: public; Owner: nickfiddes
--

ALTER TABLE ONLY public.workflow_field_mapping
    ADD CONSTRAINT workflow_field_mapping_unique_field_mapping UNIQUE (field_name, substage_id, accordion_type);
