...
('Feature Focus', 'feature', 'Create an engaging Facebook post about this Clan.com product, focusing on its key features and specifications. Keep it under 200 characters, include 3-5 relevant hashtags, and make it sound exciting and authentic. IMPORTANT: End the post with a simple call-to-action followed by the URL like "Shop now at {product_url}" or "Discover more at {product_url}". Do NOT use square brackets or markdown formatting. Product: {product_name} - {product_description}'),
('Benefit Focus', 'benefit', 'Create an engaging Facebook post about this Clan.com product, focusing on the benefits and value it provides to customers. Keep it under 200 characters, include 3-5 relevant hashtags, and make it sound compelling and customer-focused. IMPORTANT: End the post with a simple call-to-action followed by the URL like "Shop now at {product_url}" or "Discover more at {product_url}". Do NOT use square brackets or markdown formatting. Product: {product_name} - {product_description}'),
('Story Focus', 'story', 'Create an engaging Facebook post about this Clan.com product, telling a story about its heritage, craftsmanship, or how it fits into Scottish culture. Keep it under 200 characters, include 3-5 relevant hashtags, and make it emotional and storytelling-focused. IMPORTANT: End the post with a simple call-to-action followed by the URL like "Shop now at {product_url}" or "Discover more at {product_url}". Do NOT use square brackets or markdown formatting. Product: {product_name} - {product_description}');
