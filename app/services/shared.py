...
def get_all_posts_from_db():
    ...
    try:
        ...
        if not conn:
            ...
            raise Exception("Database connection failed - no connection returned")
        ...
        raise Exception(f"Failed to get posts from database: {e}")
...
def get_workflow_stages_from_db():
    ...
    try:
        ...
        logger.error(f"Database query error: {e}")
        raise Exception(f"Failed to get workflow stages from database: {e}")
