#!/usr/bin/env python3
"""
Add or update the Section Drafting prompt in the llm_prompt table.
This prompt is designed for generating individual section drafts with full context awareness.
"""
...
def add_section_drafting_prompt():
    """Add or update the Section Drafting prompt"""
...
- Avoid generic or bland content that could apply to any topic"""
    ...
    prompt_text = """You are tasked with writing a compelling draft for ONE section of a blog post about [EXPANDED_IDEA]. You have full context of the entire post to ensure uniqueness and avoid repetition.

POST OVERVIEW:
Title: [POST_TITLE]
Brief Description: [POST_DESCRIPTION]
...
AVOID THESE TOPICS (covered in other sections):
[OTHER_SECTIONS_TOPICS]

CONTENT REQUIREMENTS:
- Write 300-500 words of engaging, authentic content
- Focus specifically on the topics listed for this section
- Avoid any topics listed in "AVOID THESE TOPICS"
...
- Include cultural significance and heritage connections
- Make content accessible to both Scottish and international audiences
...
<p>Additional content paragraph with stories or historical information...</p>
<p>Concluding paragraph that ties back to Scottish heritage significance...</p>"""
    ...
    try:
        with db_manager.get_cursor() as cursor:
            ...
            logger.info("Section Drafting prompt successfully added/updated")
            
    except Exception as e:
        logger.error(f"Error adding Section Drafting prompt: {e}")
        raise

if __name__ == "__main__":
    add_section_drafting_prompt()
