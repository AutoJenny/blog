...
19	user	Expand the following short idea into a paragraph-length brief for a long-form blog article. The brief should outline the scope, angle, tone, and core ideas that could be developed into a full article. Use clear, engaging language.	{operation}	2	2025-05-26 10:27:05.283848	2025-05-29 08:36:01.078099	idea_seed expansion	\N	\N
4	user	The style should have a traditional Scottish style	{style}	4	2025-05-25 17:32:28.03507	2025-05-29 08:36:14.038682	Scottish style	\N	\N
29	system	You are a Managing Editor specialising in blog and social media creation, with an academic background in Scottish history and culture.	{role}	1	2025-05-29 08:38:49.803069	2025-05-29 08:38:49.803069	Scottish Blog basis	\N	\N
18	system	You are an expert in Scottish history and culture, dedicated to accuracy and authenticity in everything you do. You adhere to academic values, but love to popularise ideas to make them easily understandable to those with no knowledge of your specialism.	{style}	2	2025-05-26 10:20:26.867218	2025-05-29 08:39:54.868762	Scottish cultural expert	\N	\N
...
31	user	Write a short poem	{operation}	0	2025-05-29 14:05:06.207721	2025-05-29 14:05:06.207721	Poem	\N	\N
32	user	Write entirely in French	{style}	0	2025-05-29 14:05:25.466507	2025-05-29 14:05:45.298921	French	\N	\N
33	system	Start every response with "TITLE: NONSENSE"	{role}	0	2025-05-29 14:06:43.34658	2025-05-29 14:06:43.34658	Title Imposer	\N	\N
\.
...
16	dog breakfasts...	dog-breakfasts		2025-05-28 21:11:19.909206	2025-05-28 21:11:19.909206	\N	draft	\N
17	gin distillation...	gin-distillation		2025-05-29 18:52:00.672093	2025-05-29 18:52:00.672093	\N	draft	\N
\.
...
8	15	Here is a paragraph-length brief for a long-form blog article on "Cream Distillation":\n\nTitle: The Forgotten Art of Cream Distillation: Uncovering Scotland's Hidden Whisky Heritage\n\nScope and Angle: This article will delve into the fascinating history of cream distillation, a once-ubiquitous whisky production method in 18th and 19th-century Scotland. By exploring the origins, evolution, and eventual decline of this technique, we'll reveal the complex relationships between whisky-making, Scottish culture, and the country's rich agricultural heritage.\n\nTone: The article will adopt an engaging, narrative tone, balancing historical accuracy with accessible storytelling. We'll avoid overly technical language, instead using vivid descriptions and anecdotes to bring the world of cream distillation to life for readers unfamiliar with Scotland's whisky history.\n\nCore Ideas:\n\n* Introduce the concept of cream distillation, explaining its unique characteristics and how it differs from pot still distillation.\n* Explore the historical context in which cream distillation emerged as a dominant method in Scottish whisky production, including the influence of agricultural practices and regional variations.\n* Discuss notable examples of Scottish distilleries that employed cream distillation, highlighting their successes and challenges.\n* Analyse the factors contributing to the decline of cream distillation, such as changes in legislation, shifts in consumer preferences, and advances in technology.\n* Consider the legacy of cream distillation in modern Scottish whisky production, including its impact on flavour profiles and the ongoing quest for innovation.\n\nBy examining the history and cultural significance of cream distillation, this article will offer a fresh perspective on Scotland's whisky heritage, revealing the intricate connections between tradition, innovation, and the country's rich cultural landscape.	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	cream distillation
\.
...
1	9	idea	3	Action	0
32	16	idea	49	Action	0
33	17	idea	49	Action	0
9	15	idea	48	Action	0
\.
...
SELECT pg_catalog.setval('public.llm_action_id_seq', 49, true);
...
SELECT pg_catalog.setval('public.llm_prompt_id_seq', 43, true);
...
SELECT pg_catalog.setval('public.llm_prompt_part_id_seq', 33, true);
...
SELECT pg_catalog.setval('public.post_development_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.post_substage_action_id_seq', 33, true);
