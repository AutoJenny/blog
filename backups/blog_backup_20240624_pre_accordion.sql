...
2	basic_idea	10	1	2
3	idea_scope	10	1	3
4	provisional_title	10	1	4
5	research_notes	10	2	1
6	interesting_facts	10	2	2
7	topics_to_cover	10	2	3
8	section_planning	10	3	1
9	section_headings	10	3	2
10	section_order	10	3	3
11	structure	10	3	4
1	idea_seed	10	1	1
\.
...
1	1	1	input1	basic_idea
3	1	22	idea_seed	idea_seed
\.
...
SELECT pg_catalog.setval('public.post_development_id_seq', 31, true);
...
SELECT pg_catalog.setval('public.workflow_field_mapping_id_seq', 12, true);
...
--
-- Name: workflow_field_mapping workflow_field_mapping_field_name_substage_id_key; Type: CONSTRAINT; Schema: public; Owner: nickfiddes
--

ALTER TABLE ONLY public.workflow_field_mapping
    ADD CONSTRAINT workflow_field_mapping_field_name_substage_id_key UNIQUE (field_name, substage_id);
