...
COPY public.image_format (id, title, description, created_at, updated_at) FROM stdin;
34	Landscape	1536 × 1024 landscape	2025-05-07 09:42:01.592101	2025-05-07 09:42:01.59211
\.
...
COPY public.image_setting (id, name, style_id, format_id, created_at, updated_at) FROM stdin;
1	CLAN inkwash landscape	6	34	2025-05-07 15:48:35.09994	2025-05-07 15:48:35.099946
\.
