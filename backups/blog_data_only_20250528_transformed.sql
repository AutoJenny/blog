...
14	assistant	Your task is to expand the basic idea of {{basic_idea}} into an around 50 (fifty) ideas that outline and describe the full scope of an in-depth blog article about that topic in Scottish culture. Suggest (for example) different historical angles, cultural significance, social impact, key events or periods, folklore, notable figures, and/or modern relevance. Focus on breadth of ideas without writing the actual article — this list will as a guide for what should be covered in a full blog post. Keep each idea succinct but be imaginative, including both grand scale ideas and micro ideas. 	{role}	\N	2025-05-26 07:55:08.615401	2025-05-26 07:55:08.615401	Create 50 ideas	\N	\N
4	user	The style should have a traditional Scottish style	{role}	\N	2025-05-25 17:32:28.03507	2025-05-26 07:55:25.936599	Scottish style	\N	\N
26	system	Test content	{context,custom}	\N	2025-05-27 17:34:51.927527	2025-05-27 17:34:51.927527	Test Part	\N	\N
27	system	Test content	{context,custom}	\N	2025-05-27 17:36:25.735135	2025-05-27 17:36:25.735135	UI Test Part	\N	\N
28	system	Use the following input content to transform as instructed: [data:FIELDNAME]	{format}	\N	2025-05-27 17:43:11.814585	2025-05-27 17:43:11.814585	Use [data:FIELDNAME]	\N	\N
18	system	You are an expert in Scottish history and culture, dedicated to accuracy and authenticity in everything you do. You adhere to academic values, but love to popularise ideas to make them easily understandable to those with no knowledge of your specialism.	{role}	\N	2025-05-26 10:20:26.867218	2025-05-26 10:20:26.867218	Scottish cultural expert	\N	\N
8	system	You are a creative assistant generating a captivating illustration idea for a section of a Scottish-interest blog article. The image must be historically and culturally authentic, relevant to the specific section, and visually distinct from other sections of the article. 	{role}	\N	2025-05-25 20:16:54.255069	2025-05-26 10:21:08.159163	Creative visualiser	\N	\N
9	system	You are a researcher specialising in finding curious facts for blog articles for specialist audiences.	{role}	\N	2025-05-26 07:41:45.978276	2025-05-26 10:21:16.303707	Factoid researcher	\N	\N
11	system	You are a researcher specialising in sub-editing blog articles for specialist audiences. 	{role}	\N	2025-05-26 07:46:28.823794	2025-05-26 10:21:26.491256	Sub-editor	\N	\N
12	system	You are a professional copywriter and editor specializing in digital publishing and historical blogging.	{role}	\N	2025-05-26 07:47:33.873145	2025-05-26 10:21:33.122181	Editor-copywriter	\N	\N
13	system	You are an experienced Social Media marketeer and content strategist. 	{role}	\N	2025-05-26 07:48:43.999092	2025-05-26 10:21:40.448863	Social media strategist	\N	\N
19	system	Expand the following short idea into a paragraph-length brief for a long-form blog article. The brief should outline the scope, angle, tone, and core ideas that could be developed into a full article. Use clear, engaging language.	{operation}	\N	2025-05-26 10:27:05.283848	2025-05-27 17:56:58.179349	idea_seed expansion	\N	\N
15	system	Return only a valid JSON array of ideas, with no preamble, commentary, or formatting. Output must begin with [ and end with ] — no code blocks or text outside the array.	{format}	\N	2025-05-26 07:56:30.930082	2025-05-27 07:55:10.768261	JSON format	\N	\N
16	system	You are a naming assistant that returns exactly three creative but plausible names for each item provided.	{specimen}	\N	2025-05-26 08:34:59.747679	2025-05-27 07:55:34.216258	SPECIMEN SYSTEM	\N	\N
17	user	Here is a JSON list of items:\\n\\n{\\"animals\\": [\\"dog\\", \\"cat\\", \\"bird\\", \\"hamster\\", \\"lizard\\"]}\\n\\nPlease return a JSON object where each animal has an array of three possible names.	{specimen}	\N	2025-05-26 08:36:08.771728	2025-05-27 08:00:34.170418	SPECIMEN USER	\N	\N
21	system	Here is a JSON list of items:	{format}	\N	2025-05-27 08:02:58.7468	2025-05-27 08:02:58.7468	Input JSON list	\N	\N
22	system	Here is a section of text to process:	{format}	\N	2025-05-27 08:04:06.164223	2025-05-27 08:04:06.164223	Input TEXT section	\N	\N
24	system	Please return a section of text with NO commentary, annotations, or special markup.	{format}	\N	2025-05-27 08:07:03.50217	2025-05-27 08:07:03.50217	Output plain TEXT	\N	\N
23	system	Please return a JSON object where each item is in an array identified as ITEM. Return no preamble, commentary, or formatting, and no code blocks or text outside the array	{format}	\N	2025-05-27 08:05:33.661989	2025-05-27 08:08:37.715938	Output JSON	\N	\N
\.
...
COPY public.post_categories (post_id, category_id, PRIMARY) FROM stdin;
\.
...
8	15	\N	cream distillation	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N
\.
...
COPY public.post_tags (post_id, tag_id, PRIMARY) FROM stdin;
\.
