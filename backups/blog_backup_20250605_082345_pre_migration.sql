...
39	user	You will be given:\n- A provisional title for broad orientation.\n- A basic idea describing the scope and themes to be explored.\n- A set of interesting facts, each of which must be included in exactly one section.\n\nYour tasks:\n1. Devise and name a coherent, engaging section structure for the article. Each section should have a title and a short description.\n2. Allocate every theme, idea, and fact to exactly one section. No item should be left unassigned or assigned to more than one section.\n3. Output a JSON object with a "sections" array. Each section must include:\n   - "name": Section title\n   - "description": Short summary of the section\n   - "themes": List of assigned themes/ideas (if any)\n   - "facts": List of assigned facts (if any)\n4. If any theme, idea, or fact cannot be assigned, include it in an "unassigned" section at the end of the array.\n\nBe robust: handle any subject matter, and ensure the output is valid JSON.	{operation}	22	2025-06-05 08:11:57.589578	2025-06-05 08:11:57.589578	Section Creator instructions	\N	\N
...
37	system	You are an expert editorial planner for long-form articles. Your job is to design a clear, engaging, and logically structured set of sections for a new article, based on the provided title, idea, and facts.	{role}	5	2025-06-05 08:09:50.261501	2025-06-05 08:09:50.261501	Section Creator	\N	\N
38	system	Write for a general audience. Ensure the structure is accessible, engaging, and covers all provided themes and facts without overlap.	{style}	12	2025-06-05 08:10:58.158061	2025-06-05 08:10:58.158061	Section Creator voice	\N	\N
40	user	Title: {{provisional_title}}\nBasic Idea: {{basic_idea}}\nInteresting Facts:\n{{#each interesting_facts}}\n- {{this}}\n{{/each}}	{format}	32	2025-06-05 08:12:52.334262	2025-06-05 08:12:52.334262	Section Creator format	\N	\N
\.
...
SELECT pg_catalog.setval('public.llm_action_id_seq', 55, true);
...
SELECT pg_catalog.setval('public.llm_prompt_id_seq', 50, true);
