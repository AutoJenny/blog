...
- **Facebook culture/heritage header and formatting:** Exact header strings (UNDERSTANDING SCOTLAND, SCOTTISH HERITAGE), newline rules, preview/publish parity. See [FACEBOOK_CULTURE_HERITAGE_FORMATTING.md](FACEBOOK_CULTURE_HERITAGE_FORMATTING.md) and [PREVIEW_FACEBOOK_MATCH_PUBLISH.md](PREVIEW_FACEBOOK_MATCH_PUBLISH.md). Run parity script when format logic changes: `scripts/prove_preview_publish_parity.py --platform facebook --weeks 2 --qa-format`.
- **CULTURE v1.1:** Library-driven Mon/Thu culture_fact posts — Phase A (schema), Phase B (generator, creator, schedule API), Phase B.2 (publish + preview). Reports: [CULTURE_V1_1_REBRIEF_CONFIRMATION_AND_PHASE_A_REPORT.md](CULTURE_V1_1_REBRIEF_CONFIRMATION_AND_PHASE_A_REPORT.md), [CULTURE_V1_1_PHASE_B_REPORT.md](CULTURE_V1_1_PHASE_B_REPORT.md), [CULTURE_V1_1_PHASE_B2_REPORT.md](CULTURE_V1_1_PHASE_B2_REPORT.md). Tables: `culture_library` (247 rows), `heritage_library` (216 rows). Ingest: `scripts/ingest_culture_library_csv.py`, `scripts/ingest_heritage_library_csv.py` (both support `--run-migration`).
- **Report for coding adviser:** [REPORT_FOR_CODING_ADVISER_20260129.md](REPORT_FOR_CODING_ADVISER_20260129.md) — Summary of work since last adviser instructions (Phase B.2, culture + heritage ingestion, doc updates).
