#!/usr/bin/env python3
"""
Retry Failed Member Design Descriptions

This script identifies Member Design tartans that failed to get descriptions
and retries them with the improved parsing logic.
"""
...
def retry_failed_member_designs():
    """Retry generating descriptions for failed Member Design tartans"""
    ...
    logger.info(f"Found {len(failed_tartans)} failed Member Design tartans to retry")
    ...
    for i, (base_name, tartan_group) in enumerate(grouped_designs.items()):
        logger.info(f"\n============================================================")
        logger.info(f"Retrying {i+1}/{len(grouped_designs)}: {base_name} Member Design")
        logger.info(f"============================================================")
        ...
        try:
            ...
            if response and 'content' in response:
                ...
                # Parse descriptions with improved logic
