...
import { ImagePromptsOutputPanel } from './image-prompts-output-panel.js';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function initializeLLMForSection(sectionId) {
      // Initialize LLM module with image_prompts configuration
      const llmModule = initializeLLMModule('image_prompts', postId, sectionId);
    if (llmModule) {
