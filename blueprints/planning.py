...
{{
  "sections":[
    {{
      "id":"S01",
      "title":"...",
      "scope":"<=25 words covering unique focus",
      "include_keywords":["k1","k2","k3","..."],
      "exclude_keywords":["..."],
      "notes":"<=12 words to clarify boundaries"
    }}
  ]
}}

RESPONSE_RULES:
- Exactly 7 objects with ids S01..S07
- No duplicates, no overlap in scope sentences
- JSON only"""
