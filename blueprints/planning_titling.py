"""
Planning Titling Module

Extracted from planning_sections.py to reduce file bloat.
Handles section title generation and saving for theme posts.
"""
...
def api_save_sections(post_id):
    ...
    try:
        ...
        try:
            # Import sanitize function from planning_sections
            from blueprints.planning_sections import sanitize_sections_text
