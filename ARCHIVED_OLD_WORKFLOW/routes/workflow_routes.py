# ARCHIVED: Old Workflow Routes - DO NOT USE
# This file contains the deprecated workflow routes from blueprints/core.py
# Archived on: 2025-11-01
# Reason: Old workflow system (/workflow/posts/*) has been replaced by unified system
...
# NOTE: This blueprint is NOT registered - code is archived for reference only

bp = Blueprint('workflow_archived', __name__)
