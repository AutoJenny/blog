...
10	1	Basic Idea	Capture the core concept and main points of your post	1
11	1	Provisional Title	Create a working title that reflects your main idea	2
14	1	Main	Main step for this substage	1
\.
...
SELECT pg_catalog.setval('public.workflow_stage_entity_id_seq', 29, true);
...
--
-- Name: workflow_step_entity workflow_step_entity_name_sub_stage_id_key; Type: CONSTRAINT; Schema: public; Owner: nickfiddes
--

ALTER TABLE ONLY public.workflow_step_entity
    ADD CONSTRAINT workflow_step_entity_name_sub_stage_id_key UNIQUE (name, sub_stage_id);
