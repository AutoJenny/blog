...
def create_app(config_name=None):
    ...
    from blueprints.launchpad.publishing import bp as publishing_bp
    app.register_blueprint(publishing_bp, url_prefix='/launchpad')
    
    from blueprints.launchpad.publishing_validation import bp as publishing_validation_bp
    app.register_blueprint(publishing_validation_bp, url_prefix='/launchpad')
    ...
    # Register content search API blueprint
    from blueprints.content_search_api import bp as content_search_bp, register_routes
    register_routes(content_search_bp)
    app.register_blueprint(content_search_bp)
    
    # Register content generation API blueprint
    from blueprints.content_generation_api import bp as content_generation_bp
    ...
    # Register product browser blueprint
